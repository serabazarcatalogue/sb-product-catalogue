...
// script.js এ এই ভ্যারিয়েবলটি খুঁজে বের করুন এবং এটি দিয়ে প্রতিস্থাপন করুন:

// script.js এ এই ভ্যারিয়েবলটি খুঁজে বের করুন এবং এটি দিয়ে প্রতিস্থাপন করুন:

// Contact Numbers for Modal
const CONTACT_INFO = `
    <div class="contact-info">
        ...
        <p style="margin-top: 10px;">
            <a href="https://wa.me/8801611006666" target="_blank" style="display: inline-flex; align-items: center; gap: 5px; margin-right: 15px;">
                 <img src="images/whatsapp_icon.png" alt="WhatsApp" class="whatsapp-small-icon" /> 01611006666
            </a>
            <a href="https://wa.me/8801908528987" target="_blank" style="display: inline-flex; align-items: center; gap: 5px;">
                 <img src="images/whatsapp_icon.png" alt="WhatsApp" class="whatsapp-small-icon" /> 01908528987
            </a>
        </p>
    </div>
`;
...
// --- PAGINATION FUNCTIONS (Updated to use filteredProducts) ---
